...
- **Secondary** (`[hex]`): [usage]
- **Tertiary** (`[hex]`): [usage]
- **Neutral** (`[hex]`): [usage, e.g., backgrounds, surfaces]
- **Surface** (`[hex]`): [usage, e.g., card/panel backgrounds]
- **On-surface** (`[hex]`): [usage, e.g., primary text]
- **Error** (`[hex]`): [usage]
...
|------|------|-------------|--------|-------|
| H1 | `[value]` | `[value]` | `[value]` | Page title |
| H2 | `[value]` | `[value]` | `[value]` | Section title |
| Body | `[value]` | `[value]` | `[value]` | Body text |
| Small | `[value]` | `[value]` | `[value]` | Helper text |
